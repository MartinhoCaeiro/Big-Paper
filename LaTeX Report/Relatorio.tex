...
%---------------------------------------------------------------------------------------------------------------------------
\newpage
Em termos conclusivos, o Tribunal de Justiça respondeu que os operadores de plataformas como o YouTube
e a Uploaded não realizam, em regra, um ato de “comunicação ao público” na aceção do Artigo 3.º da Diretiva 2001/29/CE
quando os utilizadores colocam ilegalmente conteúdos protegidos, desde que esses operadores se limitem a disponibilizar
a plataforma de forma neutra e não desempenhem um papel ativo que lhes confira conhecimento ou controlo sobre os conteúdos.

Contudo, o Tribunal esclareceu igualmente que a responsabilidade poderá existir caso o operador tenha conhecimento
da disponibilização ilícita e não atue de forma diligente, designadamente removendo ou bloqueando o acesso aos conteúdos,
bem como que os titulares de direitos mantêm o direito de obter injunções contra estes intermediários.
Deste modo, o resultado final dos processos C-682/18 e C-683/18 foi a confirmação de que não existe
responsabilidade automática e generalizada dos operadores pelos conteúdos carregados pelos utilizadores,
mas sim um regime dependente do grau de intervenção da plataforma e do seu comportamento após tomar conhecimento
da ilegalidade.\\

Em termos de apreciação pessoal, concordo com a decisão do Tribunal de Justiça, na medida em que esta respeita
o enquadramento jurídico aplicável à data dos factos e mantém um equilíbrio entre a proteção dos direitos de autor
e a inexistência de um dever geral de fiscalização por parte dos operadores.
Ainda assim, considero que o regime introduzido pela Diretiva (UE) 2019/790, em especial o seu Artigo 17.º,
teria permitido uma solução mais favorável aos titulares de direitos, caso já estivesse em vigor no momento em que ocorreram
as infrações analisadas.
Na minha perspetiva, teria sido desejável que esta alteração legislativa tivesse sido adotada mais cedo,
uma vez que reflete de forma mais adequada a realidade do funcionamento das plataformas digitais
e o impacto que estas têm na disponibilização e difusão massiva de conteúdos protegidos.
